...
public class LoginDAO {
    ...
    public Account checkLogin(String acc, int pass){
    ...
    public void register(String acc, int pass, String email ,String roles){
    ...
    public Account checkPass(int pass, String id){
    ...
    public void changPassById(int pass, int oldpass, String id) {
        String query = "UPDATE ManageUsers\n"
                + "SET Passwords = ?\n"
                + "WHERE Passwords = ?\n"
                + "AND UserID = ?";
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "test" + dao.checkCustomer("hau"));
    }
}
